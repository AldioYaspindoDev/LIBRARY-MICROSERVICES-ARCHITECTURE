...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, BukuCommand> consumerFactory() {
        ...
        JsonDeserializer<BukuCommand> deserializer = new JsonDeserializer<>(BukuCommand.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, BukuCommand> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, BukuCommand> factory = new ConcurrentKafkaListenerContainerFactory<>();
